...
Title: Smart Student Performance Analytics Platform 
Team: Adeniyi Ridwan Adetunji
WorkID: cp630oc-project
Statement: I claim that the enclosed project submission is my team work.  
...
R1.5 [0/25/*] Create deployable service components using application models using Java based enterprise computing technologies, to create client program to do remote call of the data mining services.

R1.6 [0/25/*] Deploy service components onto enterprise application servers.

R1.7 [0/25/*] Create web services (SOAP, RESTful) to use the data service components.

R1.8 [0/25/*] Create web user interface/mobile applications to use the application/web services.
